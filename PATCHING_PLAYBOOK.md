...
- 2.1.246-style request builders store the display eligibility guards in an intermediate local before reading `thinkingConfig.display`; default that guarded read to `"summarized"` or the reducer receives no displayable live-thinking text.
